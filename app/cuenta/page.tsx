    ...
    <div className="min-h-screen w-full bg-[#09090b] text-white flex flex-col font-sans select-none">
      ...
      {viewingTicketQr && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
          <div className="w-full max-w-sm bg-white text-zinc-900 rounded-[28px] p-6 text-center space-y-4 shadow-2xl relative font-sans">
            <button
              type="button"
            ...
            <div className="space-y-0.5 text-xs text-zinc-500 font-mono">
              ...
              <p className="text-[10px] text-zinc-900 font-bold uppercase">
                {viewingTicketQr.status === "confirmed" ? "✓ Válido para 1 escaneo en puerta" : "En espera de verificación"}
              </p>
            </div>
          </div>
        </div>
